...
#define MPI_ERR_LASTCODE                      \
    0x3fffffff /* Last valid error code for a \
predefined error class */
#define MPICH_ERR_LAST_CLASS             \
    53 /* It is also helpful to know the \
last valid class */
...
int MPI_Comm_spawn_multiple(
    int, char *[], char **[], int[], MPI_Info[], int, MPI_Comm, MPI_Comm *, int[]);
...
int MPI_Alltoallw(
    void *, int[], int[], MPI_Datatype[], void *, int[], int[], MPI_Datatype[], MPI_Comm);
...
int MPI_Comm_create_keyval(
    MPI_Comm_copy_attr_function *, MPI_Comm_delete_attr_function *, int *, void *);
...
int MPI_Type_create_keyval(
    MPI_Type_copy_attr_function *, MPI_Type_delete_attr_function *, int *, void *);
...
int MPI_Win_create_keyval(
    MPI_Win_copy_attr_function *, MPI_Win_delete_attr_function *, int *, void *);
...
int MPI_Type_create_darray(
    int, int, int, int[], int[], int[], int[], int, MPI_Datatype, MPI_Datatype *);
...
int PMPI_Scatterv(
    void *, int *, int *displs, MPI_Datatype, void *, int, MPI_Datatype, int, MPI_Comm);
